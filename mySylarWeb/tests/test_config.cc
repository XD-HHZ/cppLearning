...
void test_yaml(){
    YAML::Node root = YAML::LoadFile("/home/huanghz/cppLearning/CPPLearning/mySylarWeb/bin/conf/test.yml");
    print_yaml(root, 0);
...
#define XX_M(g_var, name, prefix) \
    ...
    XX_M(g_str_int_map_value_config, int_str_int_map, before);
    XX_M(g_str_int_umap_value_config, int_str_int_umap, before);
    ...
    XX_M(g_str_int_map_value_config, int_str_int_map, after);
    XX_M(g_str_int_umap_value_config, int_str_int_umap, after);
...
void test_class(){
    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "befor: " << g_person->getValue().toString() << " - " << g_person->toString();
...
void test_log(){
    ...
    YAML::Node root = YAML::LoadFile("/home/hhz/cppLearning/myGit/mySylarWeb/bin/conf/log.yml");
    sylar::Config::LoadFromYaml(root); 
    std::cout << "======================" << std::endl;
    std::cout << sylar::LoggerMgr::GetInstance()->toYamlString() << std::endl;;
    SYLAR_LOG_INFO(system_log) << "hello system" << std::endl;
